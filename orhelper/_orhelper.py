...
CLASSPATH = os.environ.get("CLASSPATH", "OpenRocket-24.12.jar")
jdk_path = os.path.join(current_directory, 'Java', 'jdk-23')
...
class OpenRocketInstance:
    ...
    def __enter__(self):
        ...
        self.wind = jpype.JPackage("info").openrocket.core.models.wind
